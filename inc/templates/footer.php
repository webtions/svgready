<?php
/**
 * SVG Ready – Footer Template
 *
 * Contains the closing markup and scripts for the page.
 *
 * @package SVGready
 * @since   1.0.0
 */
...
<footer class="site-footer">
    ...
    <hr class="sep-dots" aria-hidden="true">
    <p>
<svg xmlns="http://www.w3.org/2000/svg" width="120"  viewBox="0 0 300 152" fill="none">
...
document.addEventListener(
    ...
    if (form) {
        form.addEventListener(
            'submit', () => {
            // Track a named event; will automatically appear in your Fathom dashboard
            if (window.fathom) { fathom.trackEvent('Convertion');
            }
            }
        );
    }
