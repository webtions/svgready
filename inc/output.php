<section class="output-section" aria-labelledby="output-heading">
    ...
    <?php if ($input_svg !== '' ) : ?>
        <article class="result-block">
            <h4>SVG Preview</h4>
            <div class="preview-container" role="img" aria-label="SVG Preview"><?php echo $normalized; ?></div>
        </article>

        <article class="result-block">
            <h4>
                Normalized SVG
                <button class="copy-btn" data-copy="<?php echo h($normalized); ?>">Copy</button>
            </h4>
        ...
        <article class="result-block">
            <h4>
                ...
                <button class="copy-btn" data-copy="<?php echo h($data_uri_css); ?>">Copy</button>
            </h4>
        ...
        <article class="result-block">
            <h4>
                ...
                <button class="copy-btn" data-copy="<?php echo h($bg_snippet); ?>">Copy</button>
            </h4>
        ...
        <article class="result-block">
            <h4>
                Mask Image CSS
                <button class="copy-btn" data-copy="<?php echo h($mask_snippet); ?>">Copy</button>
            </h4>
        ...
        <?php if ($show_base64 ) : ?>
            <article class="result-block">
                <h4>
                    Base64 Data URI
                    <button class="copy-btn" data-copy="<?php echo h($data_uri_b64); ?>">Copy</button>
                </h4>
